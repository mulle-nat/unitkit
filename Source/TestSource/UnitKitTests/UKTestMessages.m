...
- (void) testUKIntsEqual
{
    UKIntsEqual(1, 1);
    [handler setDelegate:nil];   
    NSString *expected = [NSString stringWithFormat:[self localizedString:@"msgUKIntsEqual.pass"], 1LL, 1LL];
    UKStringsEqual(expected, reportedMessage);
}
...
- (void) testUKIntsEqual_Negative
{
    UKIntsEqual(1, 2);
    [handler setDelegate:nil];
    NSString *expected = [NSString stringWithFormat:[self localizedString:@"msgUKIntsEqual.fail"], 1LL, 2LL];
    UKStringsEqual(expected, reportedMessage);
}
