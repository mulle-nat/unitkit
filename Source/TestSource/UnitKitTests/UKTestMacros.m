...
- (void) testUKPointersEqual
{
    UKPointersEqual( (void *) 1, (void *) 1);
    [handler setDelegate:nil];
    UKTrue(reportedStatus);
}

- (void) testUKPointersNotEqual
{
    UKPointersNotEqual( (void *) 1, (void *) 2);
    [handler setDelegate:nil];
    UKTrue(reportedStatus);
}
...
{
    UKRaisesException([self raiseException:[NSException exceptionWithName:@"Test" reason:@"For testing" userInfo:nil]]);
    [handler setDelegate:nil];
    UKTrue(reportedStatus);
}
...
- (void) testUKDoesNotRaiseException
{
...
{
    UKDoesNotRaiseException([self raiseException:[NSException exceptionWithName:@"Test" reason:@"For testing" userInfo:nil]]);
    [handler setDelegate:nil];
    UKFalse(reportedStatus);
}
