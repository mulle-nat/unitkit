...
#define UKPointersEqual(a, b) [[UKTestHandler handler] testPointer:(a) equalTo:(b) inFile:__FILE__ line:__LINE__]

#define UKPointersNotEqual(a, b) [[UKTestHandler handler] testPointer:(a) notEqualTo:(b) inFile:__FILE__ line:__LINE__]
